  ...
  return (
    <div className="p-[20px]">
      ...
      <div className="grid grid-rows-1 grid-cols-12 gap-[40px]">
        <div
          data-aos="flip-left"
          className="col-span-8 flex flex-col justify-center items-center text-center max-lg:col-span-12 max-md:col-span-12 max-sm:col-span-9 max-md:pe-2"
        >
          <div
        ...
        <div
          data-aos="flip-left"
          className="col-span-4 bg-[#fff] p-[20px] rounded-xl shadow-xl max-lg:col-span-12 max-md:col-span-12 max-md:pe-3 max-sm:col-span-9"
        >
