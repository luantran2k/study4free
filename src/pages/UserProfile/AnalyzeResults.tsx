          ...
          <>
            ...
            <div className="flex justify-around text-[30px] flex-wrap gap-5">
              ...
              cursor-pointer min-w-[200px] hover:bg-[#38bdf8] hover:text-[#fff] ${
                section == 'Listening' ? 'bg-[#38bdf8] text-white' : 'text-black bg-[#fff]'
              }`}
              ...
              <span
                className={` shadow-xl py-[20px] px-[40px] rounded-3xl 
              cursor-pointer min-w-[200px] hover:bg-[#38bdf8] hover:text-[#fff] ${
                section == 'Reading' ? 'bg-[#38bdf8] text-white' : 'text-black bg-[#fff]'
              }`}
              ...
              <span
                className={` shadow-xl py-[20px] px-[40px] rounded-3xl 
              cursor-pointer min-w-[200px] hover:bg-[#38bdf8] hover:text-[#fff] ${
                section == 'Speaking' ? 'bg-[#38bdf8] text-white' : 'text-black bg-[#fff]'
              }`}
              ...
              <span
                className={`shadow-xl py-[20px] px-[40px] rounded-3xl 
              cursor-pointer min-w-[200px] hover:bg-[#38bdf8] hover:text-[#fff] ${
                section == 'Writing' ? 'bg-[#38bdf8] text-white' : 'text-black bg-[#fff]'
              }`}
