                    ...
                    <div className='w-full md:w-3/4 relative'>
                        <div className='mb-5 p-5 border-2 rounded-2xl'>
                            <div className='flex flex-row flex-wrap w-full gap-3 mb-2'>
                                {test.tag.map((t, i) => (
                                    <button
                                        className="bg-[#eeeeee] w-fit rounded-xl p-2 text-black text-sm "
                                    >
                                        #{t}
                                    </button>
                                ))}
                            ...
                            {value === 0 ? (
                                <React.Fragment>
                                    <div className='flex flex-col mb-6'>
                                        <p className='mb-1 font-bold text-lg text-black'>Exam package: {test.name}</p>
                                        <div className='flex flex-row items-center gap-2 mb-1'>
                                            <p>
                                                <ClockIcon />
                                            </p>
                                            <p>Time: 60 mins | {test.parts} parts | {test.questions} questions | {test.comment} comments</p>
                                        </div>
                                        <div className='flex flex-row items-center gap-2 mb-1'>
                                            <p>
                                                <WriteIcon />
                                        ...
                                        <p className='italic font-normal text-red-500'>Note: to be converted to a scale (for example, on a scale of 990 for TOEIC or 9.0 for IELTS), please choose FULL TEST mode.</p>
                                    ...
                                    <div className='w-full bg-[#ffefd8] p-4 text-[#855a1f] rounded-lg mb-4'>
                                        ...
                                        Ready to start taking the full test? To get the best results, you need to spend 40 minutes on this test.
                                    </div>
                                    <NavLink className='btn btn-success text-white' to='writing'>Start Exam</NavLink>
                                </React.Fragment>
                            ) : (
                                <h2>!</h2>
                            )}
                        ...
                        <div className='p-5 border-2 rounded-2xl' ref={ref}>
                            ...
                            <p className='mb-10'>
                                Please <NavLink className="hover:text-black text-blue-400" to="login">login</NavLink> to comment
                            </p>
                            <div className='flex flex-col gap-2'>
                                <div className='flex flex-row gap-2 justify-start'>
                                    ...
                                    <div className='flex flex-col'>
                                        <p><span className='font-bold'>tranyennhi2006vbhp</span>, June 24, 2023</p>
                                        <p>ai giải thích dùm mình tsao câu 13 đáp án B lại sai với ạ</p>
                                    </div>
                                </div>
                            </div>
                        </div>
