    ...
    <div className="w-full flex  h-screen relative transition-all">
      ...
      >
        <div className='absolute top-5 left-5 '>
          <NavLink to="/" className='btn text-sky-400 text-lg font-bold px-5 hover:bg-sky-50 shadow-sky-300  shadow-lg'>Home</NavLink>
        </div>
        <div className=" w-full h-full md:w-[600px] md:h-[600px] px-5 lg:px-0 mx-auto lg:mx-0 transition-all">
          <div className="flex flex-col h-full items-center justify-center">
            <div className="tabs mx-8">
              <a
                className={`tab tab-lifted tab-lg text-green-500 text-lg ${value === 0 && 'text-2xl font-bold bg-white '
                  }`}
              ...
              <a
                className={`tab tab-lifted tab-lg text-sky-400 border-none text-lg ${value === 1 && 'text-2xl font-bold bg-white'
                  }`}
